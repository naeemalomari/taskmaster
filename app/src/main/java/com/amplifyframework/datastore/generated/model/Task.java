...
public final class Task implements Model {
  ...
  private Task(String id, String title, String body, String state, String img, String lat, String lon, Team teams) {
    this.id = id;
    this.title = title;
    this.body = body;
    this.state = state;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String title, String body, String state, String img, String lat, String lon, Team teams) {
      super.id(id);
      super.title(title)
        .teams(teams)
        .body(body)
